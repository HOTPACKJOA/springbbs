...
public interface IDaoBoard {
     ...
     * 게시판  삭제
     */
    public abstract int deleteBoard(String boardcd) throws SQLException;
     ...
     * 
     */
    public abstract List<ModelBoard> getBoardPaging(int start, int end, String searchValue);
     ...
     * 게시글 수정
     */
    public abstract int updateArticle(ModelArticle Search, ModelArticle Replace);

    /*
     * 게시글 삭제
     */
    public abstract int deleteArticle(int articleNo);
     ...
     * 첨부파일 삭제
     */
    public abstract int deleteAttachFile(int attachFileNo);
     ...
     * 덧글수정
     */
    public abstract int updateComment(ModelComments comment);

    /*
     * 덧글삭제
     */
    public abstract int deleteComment(int commentNo);
